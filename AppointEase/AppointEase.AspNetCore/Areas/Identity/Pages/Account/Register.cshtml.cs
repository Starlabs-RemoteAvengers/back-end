...
using AppointEase.Application.Contracts.Roles;
...
namespace AppointEase.AspNetCore.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            if (!_roleManager.RoleExistsAsync(SD.Role_Client).GetAwaiter().GetResult())
            {
                ...
                _roleManager.CreateAsync(new IdentityRole(SD.Role_Clinic)).GetAwaiter().GetResult();
